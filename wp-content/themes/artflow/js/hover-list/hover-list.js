...
var MenuItem = /*#__PURE__*/function () {
  function MenuItem(el, inMenuPosition, animatableProperties) {
    ...
    // el is the <a> with class "s__item"
    this.DOM = {
      el: el
    ...
    this.DOM.textInner = this.DOM.el.querySelector('.p-item-textinner'); // create the image structure
  ...
  _createClass(MenuItem, [{
    ...
    value: function layout() {
      ...
      this.DOM.reveal.className = 'p-hover-reveal'; // the next two elements could actually be only one, the image element
      ...
      this.DOM.revealInner.className = 'p-hover-reveal-inner';
      this.DOM.revealImage = document.createElement('div');
      this.DOM.revealImage.className = 'p-hover-reveal-img';
      //pixelwars edit : get img from data attribute
    ...
    value: function render() {
      ...
      // pixelwars edit : - window.scrollY fix for reveal image position incorrect when natively scrolled
      this.animatableProperties.ty.current = Math.abs(mousepos.y - this.bounds.el.top - window.scrollY) - this.bounds.reveal.height / 2; // new rotation value
      ...
      _gsap.gsap.set(this.DOM.reveal, {
        ...
        // pixelwars edit: disable brihtness change effect
...
var Menu = /*#__PURE__*/function () {
  function Menu(el) {
    ...
    this.DOM.menuItems = this.DOM.el.querySelectorAll('.p-item'); // menu item properties that will animate as we move the mouse around the menu
...
// menu (<nav> element)
var menuEl = document.querySelector('.p-hover-list'); // preload the images set as data attrs in the menu items

(0, _preloader.preloader)('.p-item').then(function () {
  // initialize menu
  new _menu.default(menuEl);
});
},{"./cursor":"LMRJ","./preloader":"BeZ8", "./menu":"i0CD"}]},{},["QvaY"], null)